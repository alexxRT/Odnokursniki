...
public:
    ...
    void send (const message<T>& msg){
        ...
        [this, msg]() {
            ...
            //only if deq was emty before, so all bytes were send
            //we do not start new write_header, when old is in work
            //we just put the message in a deq and working write_header will catch it
